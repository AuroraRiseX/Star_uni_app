	...
	<view class="page">
		...
		<view class="top-bar">
			<view class="top-bar-inner">
				...
				<text class="top-title">性格养成</text>
...
export default {
	data() {
		return {
			...
			tasks: [
				{ name: '一天不发脾气', emoji: '🧘', stars: 3, done: false, color: 'purple' },
				{ name: '主动帮助他人', emoji: '🤝', stars: 3, done: false, color: 'green' },
				{ name: '诚实不说谎', emoji: '😊', stars: 5, done: false, color: 'gold' },
				{ name: '和小朋友分享玩具', emoji: '🧸', stars: 2, done: true, color: 'blue' },
				{ name: '主动向长辈问好', emoji: '👋', stars: 2, done: false, color: 'orange' }
			]
		}
	},
	computed: {
