			...
			<view class="main-content">
				...
				<view class="stats-card">
					<view class="stats-circle">
						...
						<view class="ring-fill" :style="{ 'stroke-dashoffset': ringOffset }"></view>
...
export default {
	data() {
		return {
			totalClouds: 12,
			punishments: [
				{ emoji: '😤', name: '乱发脾气', clouds: 3, recorded: false },
				{ emoji: '💢', name: '和长辈顶嘴', clouds: 5, recorded: false },
				{ emoji: '🗣️', name: '说脏话', clouds: 5, recorded: false },
				{ emoji: '😭', name: '无故哭闹', clouds: 3, recorded: false },
				{ emoji: '🤥', name: '撒谎，屡教不改', clouds: 10, recorded: false }
			]
		}
	},
	computed: {
