	...
	<view class="page">
		...
		<view class="top-bar">
			<view class="top-bar-inner">
				<view class="top-bar-left">
					...
					<text class="page-title">麦兜的星星罐</text>
				</view>
				<text class="detail-btn" @tap="showDetail">明细</text>
			</view>
		</view>
		...
		<view class="bottom-nav">
			...
			<view class="nav-item" @tap="goTo('/pages/star-jar/star-jar')">
				<text class="nav-icon" style="color: #ffd93d;">⭐</text>
				<text class="nav-label" style="color: #705d00;">奖惩</text>
			</view>
...
<style>
	...
	.bottom-nav {
		...
		box-shadow: 0 -10px 40px rgba(255,132,0,0.05);
		box-sizing: border-box;
	}
	.nav-item {
		display: flex;
